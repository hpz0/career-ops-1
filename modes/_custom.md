...
- **Active interview (priority):** Ramp — Senior Manager, Procurement Product Activation — **HM Caroline Novas, Wed Aug 12, 2026**. Prep: `interview-prep/ramp-caroline-novas-hm-cheatsheet.md` + `ramp-caroline-novas-hm.md` + playbook plan. Do NOT suggest re-applying to Ramp. Confirm remote vs Hybrid and base under 70/30 OTE if not locked.
