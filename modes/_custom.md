...
- **Active interview (priority):** Ramp — Senior Manager, Procurement Product Activation — **HM Caroline Novas, Wed Aug 12, 2026**. Only open: `interview-prep/ramp/caroline.md` (day-of) + `interview-prep/ramp/caroline-prep.md` (scripts). Do NOT suggest re-applying to Ramp. Confirm remote vs Hybrid and base under 70/30 OTE if not locked.
- **Active interview:** The Nuclear Company — Sr. Category Manager Indirect/Corporate — **HM with Rebekah O'Hara (Becki) complete.** Next: likely IT/Finance/Legal/Kevin loop. Print `interview-prep/the-nuclear-company/loop-cheatsheet.md`. Corporate seat; NetSuite + SaaS tools on existing governance. Relocation already OK — do not reopen.
