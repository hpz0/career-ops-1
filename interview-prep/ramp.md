...
## Ramp quick intel (sounds like you did homework)

**What they are:** All-in-one **financial operations** — corporate cards, expense, bill pay, **procurement**, travel, treasury. ~50k customers, $100B+ annual purchase volume. Founded 2019, NYC HQ, heavy remote hiring.

**2026 moves worth mentioning:**
- **AI agents across procurement** (Apr '26) — intake, vendor due diligence, renewal intelligence, zero-touch sourcing
- **Visa partnership expanded** (Mar '26) — autonomous bill pay, agentic payments at scale
- **TD SYNNEX channel deal** (May '26) — Ramp through IT reseller/distributor network
- **Applied AI Solutions** — Ramp engineers help enterprises deploy custom finance AI agents
- **Q2 '26 release:** AI token spend management, invoice reconciliation, "Ramp Stack"

**Integrations you can speak to (you lived this):** Coupa ecosystem, **Ironclad**, DocuSign, Jira, NetSuite/Sage — Ramp pitches bidirectional CLM/ticketing workflows. Say: *"I've been on the Ironclad side of that integration conversation."*

**Competitors (don't recite — use if asked):**
| Player | Angle |
|--------|-------|
| **Brex** | Cards + expense; strong startup/mid-market |
| **Concur / SAP** | Enterprise travel/expense incumbent — slow, bolted-on |
| **Bill.com / Divvy** | AP + spend; less unified procurement story |
| **Coupa** | Enterprise P2P source-to-pay — Ramp complements or replaces pieces |
| **Expensify** | Expense-only point solution |

**Your wedge:** *"Ramp wins when finance wants one platform, not five — and when the buyer cares about adoption, contract terms, and implementation burden, not just the demo."*
...
Fake quota · Badmouth Comcast · Lead with manufacturing/BOM — lead with **indirect spend / systems / P2P / CLM**

---

*Print: Cmd+P → 1 page. File: `career-ops/interview-prep/ramp.md`*
