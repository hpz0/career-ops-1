# Jamie Lichay — Buyer/Planner peer (Mon)

**Who:** Jamie Lichay · Maritime Procurement & Planning (Quincy) — peer / near-peer on the desk  
...
> I’m Harrison. Most of my career was manufacturing procurement at Plenty. Senior Global Supply Manager. Direct materials: BOMs and MRP in NetSuite, inventory and safety stock, S&OP, CapEx/tooling, supplier quality that stops a line.
>
> We took about 30% out of BOM cost in six months. I stood up Coupa when buying lived in NetSuite. And I ran a packaging recall: quarantine, conforming material in, vendor 100% inspection, then fix the process with Supplier Quality.
>
> I’m at Comcast on wireless and fixed network. Useful, but not the factory job. Stephen walked me through Copperhead and Seabed Sentry. That’s the work I want.
...
>
> I’m here because Anduril is trying to get advanced hardware to warfighters faster and break the old cost-plus model so taxpayers get more capability per dollar. I believe that. Maritime is a startup inside Anduril. Deadlines are real. If it’s on fire after five, you stay and clear it. Copperhead and Seabed Sentry is the book I want.

---

## Stories for her room
...
| Data / buy decisions | Samsung schedule → volumes · Nokia 90-day hold | Lead the interview with Comcast |
| Systems backup | Arena (BOM/ECO) · ETQ (SCAR/CAPA) · NetSuite | Tool tour |
...
**Commodity gap?**  
> Farm inputs + packaging + CapEx/tooling at Plenty. Method transfers. I’ll learn your part families on the floor.
...
Lead Comcast · Coupa tour · geopolitics · fake electronics depth · fluff · argue comp
