...
1. **`cheatsheet.md`** — MASTER / primary source. Best answers. Day-of bible. If an overlay drifts, trust this. **Focus: BOM → clear to build + NPI.**
2. **One person overlay for that call** (optional):
   - Jamie → `jamie-cheatsheet.md` (peer — clear-to-build / MRP)
   - Robbie → `robbie-cheatsheet.md` (sourcing → eng program / NPI)
   - Kyle → `kyle-cheatsheet.md` (NPI mechanical engineer)
   - Stephen → `stephen-cheatsheet.md` (HM)
   - Janine → `janine-cheatsheet.md` (peer)
